...
public class LithiumChlorideCollector {
    ...
    public static void load() {
        block = new GenericCrafter("lithium-chloride-collector") {{
            ...
            consumeItem(LithiumChloride.item, 1); // 消耗氯化锂干燥剂
            consumePower(2.5f);
